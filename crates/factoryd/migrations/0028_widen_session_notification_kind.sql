...
CREATE TABLE sessions_new (
    ...
    provider_resume_blocked_at_ms INTEGER
        CHECK (provider_resume_blocked_at_ms IS NULL OR provider_resume_blocked_at_ms >= 0),
    resumed_provider_session INTEGER NOT NULL DEFAULT 0
        CHECK (resumed_provider_session IN (0, 1)),
    delivery_recovery_stop_requested_at_ms INTEGER
        CHECK (
...
INSERT INTO sessions_new (
    ...
    provider_resume_blocked_at_ms, resumed_provider_session,
