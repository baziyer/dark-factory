...
/// which always migrates to the current `SCHEMA_VERSION` after the
/// connector-event, runtime metadata, legacy permission repair, model policy,
/// delivery-attempt, provider-resume recovery, observer-reason, and typed
