...
/// path is retained only for diagnostics; create/rename/unlink operations
...
/// `memory.md`, and generated provider configuration under it), if present. A
/// missing directory is not an error. Callers
