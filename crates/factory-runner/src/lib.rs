...
use terminal_log::{TERMINAL_LOG_FILE, TerminalLog, TerminalSnapshot, generation_at};
#[cfg(test)]
use terminal_log::{open_terminal_log, safe_terminal_prefix};
...
mod tests {
    use super::{
        Config, DecodedChunk, Error, MAX_STARTUP_STDIN_BYTES, TERMINAL_LOG_FILE, TerminalLog,
        attach_terminal_connection, decode_available, open_terminal_log, validate_config,
    };
    use factory_core::{
        RunId, RunnerInstanceId,
        runner::{
