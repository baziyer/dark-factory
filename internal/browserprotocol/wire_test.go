...
func encodeDecoded(frame ControlFrame) ([]byte, error) {
	...
	case AgentControl:
		return EncodeAgentControl(frame.ID, value)
	case AgentControlResult:
		return EncodeAgentControlResult(frame.ID, value)
	case TaskHistoryGet:
		return EncodeTaskHistoryGet(frame.ID, value)
	case TaskHistory:
		return EncodeTaskHistory(frame.ID, value)
	case TaskListGet:
		return EncodeTaskListGet(frame.ID, value)
	case TaskList:
		return EncodeTaskList(frame.ID, value)
	case TaskDetailGet:
	...
	case ProjectLimits:
		return encodeControl(TypeProjectLimits, frame.ID, value)
	case ProjectLimitsResult:
		return EncodeProjectLimitsResult(frame.ID, value)
	case AccountsDiscover:
		return encodeControl(TypeAccountsDiscover, frame.ID, value)
	case Accounts:
		return EncodeAccounts(frame.ID, value)
	case AccountLink:
		return encodeControl(TypeAccountLink, frame.ID, value)
	case AccountLinkResult:
		return EncodeAccountLinkResult(frame.ID, value)
	case AccountUpdate:
