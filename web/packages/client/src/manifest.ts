...
export const CONTROL_MANIFEST = [
  ...
  { type: "ACCOUNTS_DISCOVER", direction: "client", id: "required", fixture: "accounts_discover.json" },
  ...
  { type: "BROWSER_CLIENTS_GET", direction: "client", id: "required", fixture: "browser_clients_get.json" },
